...
public class EmployeeView {
	...
	public void displayMenu() {
		...
		do {
			try {
				...
				// SELECT EMP_ID, EMP_NAME, ENT_YN, ENT_DATE FROM EMPLOYEE WHERE EMP_ID = 입력한 사번
	...
	private void selectAll() {
		...
		try {
			...
			for(Employee emp : empList) {
				System.out.printf("%d / %s / %s / %s / %s \n", emp.getEmpId(),emp.getEmpName(),emp.getDepartmentTitle(),emp.getJobName(),emp.getPhone());
			}
	...
	private void selectSalary() {
		...
		try {
			...
			for(Employee emp : empList) {
				System.out.printf("%d / %s / %s / %s \n", emp.getEmpId(),emp.getEmpName(), emp.getJobName(),emp.getSalary());
			}
		} catch(SQLException e) {
