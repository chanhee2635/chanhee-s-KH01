...
ALTER TABLE "MEMBER_PROFILE" RENAME COLUMN MEBMER_CAREER TO MEMBER_CAREER;

UPDATE "MEMBER_PROFILE" SET 
PROFILE_IMG = '/resources/images/pingpong',
MEMBER_INFO = '반응형 UIUX 개발자 김핑퐁 입니다.',
MEMBER_CAREER = 'kh 정보교육원에서 국비 수업'
WHERE MEMBER_NO = 1;

INSERT INTO "BOARD" VALUES(SEQ_BOARD_NO.NEXTVAL, '1번 게시글 입니다.', DEFAULT, DEFAULT, 1);
INSERT INTO "BOARD" VALUES(SEQ_BOARD_NO.NEXTVAL, '2번 게시글 입니다.', DEFAULT, DEFAULT, 1);
INSERT INTO "BOARD" VALUES(SEQ_BOARD_NO.NEXTVAL, '3번 게시글 입니다.', DEFAULT, DEFAULT, 1);

INSERT INTO "BOARD_IMG" VALUES(SEQ_BOARD_IMG_NO.NEXTVAL, 1, '/resources/images/pingpong', 6);
INSERT INTO "BOARD_IMG" VALUES(SEQ_BOARD_IMG_NO.NEXTVAL, 2, '/resources/images/peach', 6);

SELECT MEMBER_NO, PROFILE_IMG, BACKGROUND_IMG, MEMBER_INFO, MEMBER_CAREER, MEMBER_TECH, CERTIFICATE_NO
FROM MEMBER_PROFILE
LEFT JOIN MEMBER_TECH USING(MEMBER_NO)
LEFT JOIN CAREER USING(CERTIFICATE_NO);

INSERT INTO "MEMBER_TECH" VALUES(SEQ_MEMBER_TECH_NO.NEXTVAL, 1, 1);
INSERT INTO "MEMBER_TECH" VALUES(SEQ_MEMBER_TECH_NO.NEXTVAL, 1, 2);
INSERT INTO "MEMBER_TECH" VALUES(SEQ_MEMBER_TECH_NO.NEXTVAL, 1, 3);

UPDATE "MEMBER_PROFILE" SET
PROFILE_IMG = '/resources/images/pingpong.ico';
...
INSERT INTO "BOARD_IMG" VALUES(SEQ_BOARD_IMG_NO.NEXTVAL, 1, '/resources/images/boardImage/해린1.jpg', 2);
INSERT INTO "BOARD_IMG" VALUES(SEQ_BOARD_IMG_NO.NEXTVAL, 2, '/resources/images/boardImage/해린2.jpg', 2);
INSERT INTO "BOARD_IMG" VALUES(SEQ_BOARD_IMG_NO.NEXTVAL, 3, '/resources/images/boardImage/해린3.jpg', 2);
INSERT INTO "BOARD_IMG" VALUES(SEQ_BOARD_IMG_NO.NEXTVAL, 4, '/resources/images/boardImage/해린4.jpg', 2);
INSERT INTO "BOARD_IMG" VALUES(SEQ_BOARD_IMG_NO.NEXTVAL, 5, '/resources/images/boardImage/해린5.jpg', 2);
INSERT INTO "BOARD_IMG" VALUES(SEQ_BOARD_IMG_NO.NEXTVAL, 6, '/resources/images/boardImage/해린6.jpg', 2);

INSERT INTO "BOARD_IMG" VALUES(SEQ_BOARD_IMG_NO.NEXTVAL, 3, '/resources/images/boardImage/해린4.jpg', 6);
INSERT INTO "BOARD_IMG" VALUES(SEQ_BOARD_IMG_NO.NEXTVAL, 4, '/resources/images/boardImage/해린5.jpg', 6);
INSERT INTO "BOARD_IMG" VALUES(SEQ_BOARD_IMG_NO.NEXTVAL, 5, '/resources/images/boardImage/해린6.jpg', 6);

INSERT INTO "BOARD_IMG" VALUES(SEQ_BOARD_IMG_NO.NEXTVAL, 1, '/resources/images/boardImage/해린2.jpg', 3);
INSERT INTO "BOARD_IMG" VALUES(SEQ_BOARD_IMG_NO.NEXTVAL, 1, '/resources/images/boardImage/해린3.jpg', 4);
...
SELECT MEMBER_NO, MEMBER_NICKNAME, PROFILE_IMG, BACKGROUND_IMG, MEMBER_INFO, MEMBER_CAREER  
		FROM "MEMBER_PROFILE"
...
VALUES(SEQ_COMMENT_NO.NEXTVAL, 
		...
		SYSDATE, 26, 6, DEFAULT, NULL);
INSERT INTO "COMMENT" 
VALUES(SEQ_COMMENT_NO.NEXTVAL, 
		SEQ_COMMENT_NO.CURRVAL || '번째 댓글',
		SYSDATE, 2, 6, DEFAULT, NULL);
INSERT INTO "COMMENT" 
VALUES(SEQ_COMMENT_NO.NEXTVAL, 
		SEQ_COMMENT_NO.CURRVAL || '번째 댓글',
		SYSDATE, 3, 6, DEFAULT, NULL);
	
INSERT INTO "COMMENT" 
VALUES(SEQ_COMMENT_NO.NEXTVAL, 
		'1번째 댓댓글',
		SYSDATE, 3, 6, DEFAULT, 5);
INSERT INTO "COMMENT" 
VALUES(SEQ_COMMENT_NO.NEXTVAL, 
		'2번째 댓댓글',
		SYSDATE, 3, 6, DEFAULT, 5);
...
SELECT COUNT(*)
FROM "COMMENT"
WHERE PARENT_NO IN (SELECT COMMENT_NO FROM "COMMENT");



SELECT '가나다' 
FROM DUAL 
WHERE (SELECT COUNT(*) FROM "HASHTAG" WHERE HASHTAG_NAME='가나다') = 0;

SELECT 3 BOARD_NO
		,(SELECT HASH_NO FROM "HASHTAG" WHERE HASHTAG_NAME = '가나다')
FROM DUAL 
...
FROM DUAL      
WHERE (
SELECT COUNT(*) FROM "HASHTAG" WHERE HASHTAG_NAME=?) = 0      UNION       SELECT ? HASHTAG_NAME      FROM DUAL      WHERE (SELECT COUNT(*) FROM "HASHTAG" WHERE HASHTAG_NAME=?) = 0            );

SELECT 3 BOARD_NO, (SELECT HASH_NO FROM HASHTAG WHERE HASHTAG_NAME = '해시')
			FROM DUAL; 
