...
ALTER TABLE DEPT_COPY MODIFY DEPT_TITLE NOT NULL; -- NULL 관련 설정만 MODIFY 사용!!(기억!)
...
ALTER TABLE DEPT_COPY DROP CONSTRAINT SYS_C007519;  -- NOT NULL
--> NOT NULL 제약조건 ADD는 안되는데 DROP은 가능

-- NOT NULL 제거 시 MODIFY 사용
ALTER TABLE DEPT_COPY MODIFY DEPT_TITLE CONSTRAINT SYS_C007519 /*NOT*/ NULL;
