...
CREATE TABLE MEMBER(
	...
	MEMBER_SSN  CHAR(14),      			-- 991332-1235534 (항상 14글자)
...
INSERT INTO MEMBER VALUES('MEM01', '123ABC', '홍길동', '990101-1111111', SYSDATE);
...
-- 추가 샘플 데이터 삽입
-- 가입일 -> SYSDATE를 활용
INSERT INTO MEMBER VALUES('MEM02', 'QWER1234', '김영희', '980808-2345678', SYSDATE);

-- 가입일 -> DEFAULT 활용(테이블 생성 시 정의된 값이 반영됨)
INSERT INTO MEMBER VALUES('MEM03', '1Q2W3E4R', '박철수', '950505-1987654', DEFAULT);

-- 가입일 -> INSERT 시 미작성 하는 경우 -> DEAFULT 값이 반영됨
INSERT INTO MEMBER(MEMBER_ID, MEMBER_PWD, MEMBER_NAME, MEMBER_SSN ) VALUES('MEM04','12341234','이지연','000101-4564567');
...
INSERT INTO MEMBER2 VALUES('김길동',0001013434567,01012341234);

SELECT * FROM MEMBER2;
--> MEMBER 타입으로 컬럼은 값 제일 앞 0을 유지하지 않는 문제 발생
...
--    USER_ID VARCHAR2(20) CONSTRAINT USER_ID_UK UNIQUE , -- 컬럼 레벨 제약조건 설정(이름 O)
...
--	, UNIQUE(USER_ID)  -- 제약조건(컬럼명)   (이름 미지정)
	, CONSTRAINT USER_ID_UK UNIQUE(USER_ID) -- (이름 지정)
);
...
AND UCC.CONSTRAINT_NAME = 'USER_ID_NAME_UK';
...
-- ORA-01400: NULL을 ("KH_KCH"."USER_USED_PK2"."USER_NO") 안에 삽입할 수 없습니다
--> 복합키로 PK가 설정되어 있어도
-- 결국은 PK ==> NULL 삽입 불가능
...
-- ORA-02291: 무결성 제약조건(KH_KCH.GRADE_CODE_FK1)이 위배되었습니다- 부모 키가 없습니다
---------------------------------------
...
DELETE FROM USER_GRADE
WHERE GRADE_CODE =10;
-- ORA-02292: 무결성 제약조건(KH_KCH.GRADE_CODE_FK1)이 위배되었습니다- 자식 레코드(기록)가 발견되었습니다
...
-- 체크 제약조건(KH_KCH.GENDER_CHECK)이 위배되었습니다
...
INSERT INTO USER_TEST VALUES(1,'USER01','123','000000-1000000','남','010-0000-0000','서울시 강남구 개포동','N');
